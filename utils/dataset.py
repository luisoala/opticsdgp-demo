...
class DroneDatasetSegmentationFull(ImageFolderDatasetSegmentation):
    ...
    def __init__(self, transform=None, force_download=False, bits=16):
        img_dir = 'data/drone/images_full'
...
class DroneDatasetSegmentationTiled(ImageFolderDatasetSegmentation):
    ...
    def __init__(self, transform=None):
        ...
        img_dir = f'data/drone/images_tiles_{tile_size}'
        mask_dir = f'data/drone/masks_tiles_{tile_size}'

        if not os.path.exists(img_dir) or not os.path.exists(mask_dir):
            dataset_full = DroneDatasetSegmentationFull(bits=1)
...
class DroneDatasetClassificationTiled(ImageFolderDataset):
    ...
    def __init__(self, transform=None):
        ...
        img_dir = f'data/drone/classification/images_tiles_{tile_size}_thr_{thr}'
...
class MicroscopyDataset(ImageFolderDataset):
    ...
    def __init__(self, I_ratio=1.0, transform=None, bits=16, force_download=False):
        ...
        assert I_ratio in [0.01, 0.05, 0.1, 0.25, 0.5, 0.75, 1.0]    # XXX: What is I_ratio?
...
def download_drone_dataset(force_download):
    b2_download_folder('raw', 'data/drone/images_full', force_download=force_download)
    b2_download_folder('target', 'data/drone/masks_full', force_download=force_download)
